<h2><a href="https://practice.geeksforgeeks.org/problems/common-elements1132/1?page=1&difficulty[]=-2&difficulty[]=-1&difficulty[]=0&sortBy=submissions">Common elements</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given three arrays sorted in increasing order. Find the elements that are common in all three arrays.<br>
